  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        slug: 'protect-pdf',
        name: 'Protect PDF',
        description: 'PDF password protection feature is temporarily unavailable while encryption support is being finalized.',
        icon: Shield,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'unlock-pdf',
        name: 'Unlock PDF',
        description: 'PDF unlock feature is temporarily unavailable while decryption support is being finalized.',
        icon: FileLock,
        category: 'pdf-tools',
