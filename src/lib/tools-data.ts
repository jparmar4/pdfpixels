  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Convert PDF bank statements and credit card statements into formatted Excel (.xlsx) and CSV spreadsheets for accounting and reconciliation.',
        icon: FileSpreadsheet,
        category: 'pdf-tools',
        keywords: ['bank statement to excel', 'convert bank statement to csv', 'pdf bank statement to xlsx', 'credit card statement to excel', 'bank statement converter', 'financial pdf to excel'],
        popular: true,
        badge: 'Finance',
        processing: 'server',
      },
      {
        ...
        description: 'Add sequential legal Bates numbering and confidential stamps to PDF pages for discovery, court filing, and litigation.',
        icon: Hash,
        category: 'pdf-tools',
        keywords: ['bates numbering pdf', 'bates stamping online', 'add bates numbers to pdf', 'legal page numbering', 'court filing bates stamp', 'sequential bates numbering'],
        popular: true,
        badge: 'Legal',
        processing: 'server',
      },
      ...
      {
        id: 'cmyk-pdf-converter',
        slug: 'cmyk-pdf-converter',
        name: 'CMYK PDF Converter',
        description: 'Convert RGB PDF files to true CMYK color space for professional offset printing, Amazon KDP publishing, and prepress compliance.',
        icon: Palette,
        category: 'pdf-tools',
        keywords: ['cmyk pdf converter', 'convert rgb pdf to cmyk', 'prepress pdf converter', 'print ready cmyk pdf', 'amazon kdp pdf cmyk', 'pdf for commercial printing'],
        popular: true,
        badge: 'Prepress',
        processing: 'server',
      },
      {
        ...
        icon: FileImage,
        category: 'pdf-tools',
        keywords: ['heic to pdf', 'convert iphone photo to pdf', 'heif to pdf', 'apple photo to pdf', 'heic image to pdf document', 'combine heic into pdf'],
        popular: true,
        badge: 'Apple',
        processing: 'server',
      },
      {
        ...
        description: 'Compress PDF files to under 100KB online for strict government portal uploads, job applications, and student admissions.',
        icon: Minimize2,
        category: 'pdf-tools',
        keywords: ['compress pdf to 100kb', 'reduce pdf size to 100kb online', 'resize pdf under 100 kb', 'pdf 100kb compressor', 'compress pdf for upload'],
        popular: true,
        badge: '100KB',
        processing: 'server',
      },
      {
        ...
        description: 'Reduce PDF file size to exactly 200KB or less while keeping text sharp for state licensing, college admissions, and portal limits.',
        icon: Minimize2,
        category: 'pdf-tools',
        keywords: ['compress pdf to 200kb', 'reduce pdf to 200 kb online', 'resize pdf to 200kb', 'pdf 200kb compressor', 'compress pdf under 200kb'],
        popular: true,
        badge: '200KB',
        processing: 'server',
      },
      {
        ...
        description: 'Compress PDF documents to under 300KB without visible quality loss for official passport, visa, and employment portals.',
        icon: Minimize2,
        category: 'pdf-tools',
        keywords: ['compress pdf to 300kb', 'reduce pdf size to 300kb', 'make pdf 300kb', 'pdf 300kb compressor', 'compress pdf for visa application'],
        popular: false,
        badge: '300KB',
        processing: 'server',
      },
      {
        ...
        description: 'Reduce PDF file size to 500KB or less for email attachments, corporate upload systems, and municipal form submissions.',
        icon: Minimize2,
        category: 'pdf-tools',
        keywords: ['compress pdf to 500kb', 'reduce pdf to 500kb online', 'resize pdf under 500kb', 'pdf 500kb compressor', 'compress pdf for email attachment'],
        popular: false,
        badge: '500KB',
        processing: 'server',
      },
      {
        ...
        name: 'Compress PDF Under 1MB',
        description: 'Compress multi-page PDFs to under 1MB quickly for email delivery, HR systems, and corporate portals.',
        icon: Minimize2,
        category: 'pdf-tools',
        keywords: ['compress pdf under 1mb', 'reduce pdf size to 1mb', 'compress pdf to less than 1mb', 'pdf under 1mb', 'compress pdf for outlook email'],
        popular: true,
        badge: 'Under 1MB',
        processing: 'server',
      },
